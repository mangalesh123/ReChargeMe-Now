import { PlusOne, PlusOneTwoTone, Settings } from '@mui/icons-material'
            ...
            <div className='flex space-x-10 mt-10 justify-center font-sans'>
                <div className='space-y-7 w-72 h-[30rem]'>
                    ...
                    <div className='border p-3 rounded-3xl hover:border-blue-700 cursor-pointer ml-2 mt-3'>
                        <p className='text-center font-bold text-blue-800 '>Add Prepaid Plans</p>
                    </div>
                    <div className='border p-3 rounded-3xl hover:border-blue-700 cursor-pointer ml-2 mt-3'>
                        <p className='text-center font-bold text-blue-800 '>Link Postpaid Plans</p>
                    </div>
                    <div className='border p-3 rounded-3xl hover:border-blue-700 cursor-pointer ml-2 mt-3'>
                    ...
                    <div className='space-y-5  overflow-y-hidden h-[50rem] mb-10'>
                        <div className='space-y-5 h-full overflow-y-scroll scrollbar-hide'>
                            <div className='p-4 w-[450px] rounded-2xl shadow-xl border flex flex-col justify-center '>
                                ...
                                <div className='text-gray-600 space-y-2'><p className='font-semibold text-xs font-sans'>{details.type}</p><p className='text-red-800 font-bold '>{details.role}</p><p className='text-xs'>{details.mobile_type}</p></div>
                            </div>
                            <div>
                                <div className='p-4 w-[450px] rounded-2xl shadow-xl border space-y-3 flex flex-col justify-center '>
                                    <div className='flex justify-between'><p className='text-md font-semibold'>Prepaid Plans</p>
                                    <div className='h-8 p-1 rounded w-20 flex bg-blue-800 cursor-pointer hover:bg-blue-900'><p className='flex space-x-3 font-semibold text-white ml-3'>Add <BiPlus className='text-lg mt-[2px] font-semibold ml-1'/></p></div></div>
                                    <hr />
                                    ...
                                    <div className='space-y-2'>
                                        ...
                                        <div className='overflow-x-auto  flex space-x-4 scrollbar-hide'>
                                            ...
                                            <div className='bg-light_blue p-2 rounded-xl h-48 w-[15rem]'>
                                                <div className='flex justify-between p-2'><p className='font-black text-xl'>₹849</p><div className='h-8 w-24 border rounded bg-blue_light text-center  text-white text-xs font-semibold'><p className='mt-2'>FEATURED</p></div></div>
                                                <div className='flex justify-between p-2'><p className=' text-sm text-gray-600'>Data</p><div><p className='font-semibold text-sm'>2.5 GB/day</p></div></div>
                                                <div className='flex justify-between p-2'><p className=' text-sm text-gray-600'>Validity</p><div><p className='font-semibold text-sm'>84 days</p></div></div>
                                                <div className='flex justify-center ml-4 text-white w-[200px] h-12 rounded-3xl border text-blue-700 hover:border-blue-900 bg-blue-800 cursor-pointer'><p className='text-center mt-2 text-lg font-semibold'>Recharge</p></div>
                                            </div>
                                            <div className='bg-light_blue p-2 rounded-xl h-48 w-[15rem]'>
                                                <div className='flex justify-between p-2'><p className='font-black text-xl'>₹649</p><div className='h-8 w-24 border rounded bg-blue_light text-center  text-white text-xs font-semibold'><p className='mt-2'>FEATURED</p></div></div>
                                                <div className='flex justify-between p-2'><p className=' text-sm text-gray-600'>Data</p><div><p className='font-semibold text-sm'>2 GB/day</p></div></div>
                                                <div className='flex justify-between p-2'><p className=' text-sm text-gray-600'>Validity</p><div><p className='font-semibold text-sm'>56 days</p></div></div>
                                                <div className='flex justify-center ml-4 text-white w-[200px] h-12 rounded-3xl border text-blue-700 hover:border-blue-900 bg-blue-800 cursor-pointer'><p className='text-center mt-2 text-lg font-semibold'>Recharge</p></div>
                                            </div>
                                        </div>
                            ...
                            <div>
                                <div className='p-4 w-[450px] rounded-2xl shadow-xl border space-y-3 flex flex-col justify-center '>
                                    <div className='flex justify-between'><p className='text-md font-semibold'>Postpaid Plans</p>
                                    <div className='h-8 p-1 rounded w-20 flex bg-blue-800 cursor-pointer hover:bg-blue-900'><p className='flex space-x-3 font-semibold text-white ml-3'>Add <BiPlus className='text-lg mt-[2px] font-semibold ml-1'/></p></div></div>
                                    <hr />
                                    {/* <div className='flex justify-between'>
                                    <div className='w-[200px] h-12 rounded-3xl border bg-blue-700 hover:bg-blue-900 cursor-pointer'><p className='text-center mt-2 text-lg text-white font-semibold'>Recharge</p></div>
                                    ...
                                    <div className='space-y-2'>
                                        ...
                                        <div className='overflow-x-auto  flex space-x-4 scrollbar-hide'>
                                            <div className='bg-light_blue p-2 rounded-xl h-48 w-[15rem]'>
                                                <div className='flex justify-between p-2'><p className='font-black text-xl'>₹499</p><div className='h-8 w-24 border rounded bg-blue_light text-center  text-white text-xs font-semibold'><p className='mt-2'>FEATURED</p></div></div>
                                                <div className='flex justify-between p-2'><p className=' text-sm text-gray-600'>Data</p><div><p className='font-semibold text-sm'>Unlimited</p></div></div>
                                                <div className='flex justify-between p-2'><p className=' text-sm text-gray-600'>Validity</p><div><p className='font-semibold text-sm'>Bill cycle</p></div></div>
                                                <div className='flex justify-center ml-4 text-white w-[200px] h-12 rounded-3xl border text-blue-700 hover:border-blue-900 bg-blue-800 cursor-pointer'><p className='text-center mt-2 text-lg font-semibold'>Get Now</p></div>
                                            </div>
                                            <div className='bg-light_blue p-2 rounded-xl h-48 w-[15rem]'>
                                                <div className='flex justify-between p-2'><p className='font-black text-xl'>₹399</p><div className='h-8 w-24 border rounded bg-blue_light text-center  text-white text-xs font-semibold'><p className='mt-2'>FEATURED</p></div></div>
                                                <div className='flex justify-between p-2'><p className=' text-sm text-gray-600'>Data</p><div><p className='font-semibold text-sm'>Unlimited</p></div></div>
                                                <div className='flex justify-between p-2'><p className=' text-sm text-gray-600'>Validity</p><div><p className='font-semibold text-sm'>Bill cycle</p></div></div>
                                                <div className='flex justify-center ml-4 text-white w-[200px] h-12 rounded-3xl border text-blue-700 hover:border-blue-900 bg-blue-800 cursor-pointer'><p className='text-center mt-2 text-lg font-semibold'>Get Now</p></div>
                                            </div>
                                            <div className='bg-light_blue p-2 rounded-xl h-48 w-[15rem]'>
                                                <div className='flex justify-between p-2'><p className='font-black text-xl'>₹299</p><div className='h-8 w-24 border rounded bg-blue_light text-center  text-white text-xs font-semibold'><p className='mt-2'>SONYLIV</p></div></div>
                                                <div className='flex justify-between p-2'><p className=' text-sm text-gray-600'>Data</p><div><p className='font-semibold text-sm'>Unlimited</p></div></div>
                                                <div className='flex justify-between p-2'><p className=' text-sm text-gray-600'>Validity</p><div><p className='font-semibold text-sm'>Bill cycle</p></div></div>
                                                <div className='flex justify-center ml-4 text-white w-[200px] h-12 rounded-3xl border text-blue-700 hover:border-blue-900 bg-blue-800 cursor-pointer'><p className='text-center mt-2 text-lg font-semibold'>Get Now</p></div>
                                            </div>
                                            <div className='bg-light_blue p-2 rounded-xl h-48 w-[15rem]'>
                                                <div className='flex justify-between p-2'><p className='font-black text-xl'>₹199</p><div className='h-8 w-24 border rounded bg-blue_light text-center  text-white text-xs font-semibold'><p className='mt-2'>SONYLIV</p></div></div>
                                                <div className='flex justify-between p-2'><p className=' text-sm text-gray-600'>Data</p><div><p className='font-semibold text-sm'>Unlimited</p></div></div>
                                                <div className='flex justify-between p-2'><p className=' text-sm text-gray-600'>Validity</p><div><p className='font-semibold text-sm'>Bill cycle</p></div></div>
                                                <div className='flex justify-center ml-4 text-white w-[200px] h-12 rounded-3xl border text-blue-700 hover:border-blue-900 bg-blue-800 cursor-pointer'><p className='text-center mt-2 text-lg font-semibold'>Get Now</p></div>
                                            </div>
                            ...
                            <div>
                                <div className='p-4 w-[450px] rounded-2xl shadow-xl border space-y-3 flex flex-col justify-center '>
                                    <div className='flex justify-between'><p className='text-md font-semibold'>Add-on Packs</p>
                                    <div className='h-8 p-1 rounded w-20 flex bg-blue-800 cursor-pointer hover:bg-blue-900'><p className='flex space-x-3 font-semibold text-white ml-3'>Add <BiPlus className='text-lg mt-[2px] font-semibold ml-1'/></p></div></div>
                                    <hr />
                                    {/* <div className='flex justify-between'>
                                    <div className='w-[200px] h-12 rounded-3xl border bg-blue-700 hover:bg-blue-900 cursor-pointer'><p className='text-center mt-2 text-lg text-white font-semibold'>Recharge</p></div>
                                    ...
                                    <div className='space-y-2'>
                                        ...
                                        <div className='overflow-x-auto  flex space-x-4 scrollbar-hide'>
                                            ...
                                            <div className='bg-light_blue p-2 rounded-xl h-48 w-[15rem]'>
                                                <div className='flex justify-between p-2'><p className='font-black text-xl'>₹341</p><div className='h-8 w-24 border rounded bg-blue_light text-center  text-white text-xs font-semibold'><p className='mt-2'>FEATURED</p></div></div>
                                                <div className='flex justify-between p-2'><p className=' text-sm text-gray-600'>Data</p><div><p className='font-semibold text-sm'>50GB</p></div></div>
                                                <div className='flex justify-between p-2'><p className=' text-sm text-gray-600'>Validity</p><div><p className='font-semibold text-sm'>30 days</p></div></div>
                                                <div className='flex justify-center ml-4 text-white w-[200px] h-12 rounded-3xl border text-blue-700 hover:border-blue-900 bg-blue-800 cursor-pointer'><p className='text-center mt-2 text-lg font-semibold'>Get Now</p></div>
                                            </div>
                                            <div className='bg-light_blue p-2 rounded-xl h-48 w-[15rem]'>
                                                <div className='flex justify-between p-2'><p className='font-black text-xl'>₹241</p><div className='h-8 w-24 border rounded bg-blue_light text-center  text-white text-xs font-semibold'><p className='mt-2'>FEATURED</p></div></div>
                                                <div className='flex justify-between p-2'><p className=' text-sm text-gray-600'>Data</p><div><p className='font-semibold text-sm'>30GB</p></div></div>
                                                <div className='flex justify-between p-2'><p className=' text-sm text-gray-600'>Validity</p><div><p className='font-semibold text-sm'>30 days</p></div></div>
                                                <div className='flex justify-center ml-4 text-white w-[200px] h-12 rounded-3xl border text-blue-700 hover:border-blue-900 bg-blue-800 cursor-pointer'><p className='text-center mt-2 text-lg font-semibold'>Get Now</p></div>
                                            </div>
                                            <div className='bg-light_blue p-2 rounded-xl h-48 w-[15rem]'>
                                                <div className='flex justify-between p-2'><p className='font-black text-xl'>₹141</p><div className='h-8 w-24 border rounded bg-blue_light text-center  text-white text-xs font-semibold'><p className='mt-2'>FEATURED</p></div></div>
                                                <div className='flex justify-between p-2'><p className=' text-sm text-gray-600'>Data</p><div><p className='font-semibold text-sm'>20GB</p></div></div>
                                                <div className='flex justify-between p-2'><p className=' text-sm text-gray-600'>Validity</p><div><p className='font-semibold text-sm'>30 days</p></div></div>
                                                <div className='flex justify-center ml-4 text-white w-[200px] h-12 rounded-3xl border text-blue-700 hover:border-blue-900 bg-blue-800 cursor-pointer'><p className='text-center mt-2 text-lg font-semibold'>Get Now</p></div>
                                            </div>
                                        </div>
