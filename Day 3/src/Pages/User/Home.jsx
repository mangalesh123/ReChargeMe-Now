...
function Home() {
    const slides = [
        ...
        // "https://res.cloudinary.com/dnghkq7oo/image/upload/v1710777442/choice-pay-mobile-hmpg-desk_1_n8rltr.webp"
    ]
        ...
        <div>
            ...
            <div className='flex flex-col w-[98.9vw] h-auto space-y-16'>
                ...
                <div className='w-[80rem] flex justify-center items-cneter mt-10 border shadow ml-24 rounded-xl h-[550px] p-2'>
                    ...
                    <div>
                        {/* <img className='w-96' src='https://res.cloudinary.com/dnghkq7oo/image/upload/v1710781908/20824349_6342757_yeizde.jpg'></img> */}
                    </div>
                </div>
                <div className='flex mt-5'>
                    <div className='flex flex-col '>
                        ...
                        <div className=' flex justify-evenly mt-5 space-x-4'>
                            <div className='space-y-3'><div className='h-8 w-20  text-sm rounded-xl bg-blue-800 p-2 ml-[165px] mt-1  flex items-center justify-center '><p className='text-white '>True 5g</p></div><p className='text-center  font-bold'>True 5G</p><p className='text-center text-lg  text-gray-500'>Experience the internet at lightning speed with no latency.</p></div>
            ...
            <div className='absolute top-48 left-32 space-y-5'>
                ...
                <div className='h-12 w-40 rounded-3xl  bg-blue-800  text-white text-md font-semibold cursor-pointer hover:bg-blue-900'><p className='text-center p-[10px]'>Recharge Now</p></div>
            </div>
